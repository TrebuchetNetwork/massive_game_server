...
pub const FFA_BOUNTY_MIN_KILLS: i32 = 3;
pub const FFA_BOUNTY_POINTS_MULTIPLIER: i32 = 2;
pub const FFA_BOUNTY_DAMAGE_REDUCTION: f32 = 0.10;
pub const FFA_BOUNTY_PING_INTERVAL_SECS: f32 = 10.0;
pub const MOMENTUM_SCORE_TIER_ONE_STREAK: u32 = 3;
pub const MOMENTUM_SCORE_TIER_TWO_STREAK: u32 = 5;
pub const MOMENTUM_SCORE_TIER_THREE_STREAK: u32 = 8;
pub const MOMENTUM_SCORE_TIER_ONE_MULTIPLIER: f32 = 1.5;
pub const MOMENTUM_SCORE_TIER_TWO_MULTIPLIER: f32 = 2.0;
pub const MOMENTUM_SCORE_TIER_THREE_MULTIPLIER: f32 = 3.0;
...
pub const MAP_EVENT_SUPPLY_DROP_MIN_PICKUP_SPACING: f32 = 88.0;
pub const MAP_EVENT_SUPPLY_DROP_CLUSTER_RADIUS: f32 = 220.0;
pub const MAP_EVENT_SUPPLY_DROP_MAX_ACTIVE_NEARBY: usize = 18;
pub const MAP_EVENT_SUPPLY_DROP_MAX_SPEED_BOOSTS_NEARBY: usize = 2;
