...
thread_local! {
    static MATCH_INFO_ONLY_FB_BUILDER: RefCell<flatbuffers::FlatBufferBuilder<'static>> =
        RefCell::new(flatbuffers::FlatBufferBuilder::with_capacity(2048));
}
...
impl MassiveGameServer {
    ...
    pub(crate) fn build_match_info_only_bytes(&self) -> Bytes {
        MATCH_INFO_ONLY_FB_BUILDER.with(|builder_cell| {
